...
class MetadataBuilder {
    ...
    createMiddlewares(classes) {
        const middlewares = !classes
            ? (0, index_1.getMetadataArgsStorage)().middlewares
            : (0, index_1.getMetadataArgsStorage)().filterMiddlewareMetadatasForClasses(classes);
    ...
    createInterceptors(classes) {
        const interceptors = !classes
            ? (0, index_1.getMetadataArgsStorage)().interceptors
            : (0, index_1.getMetadataArgsStorage)().filterInterceptorMetadatasForClasses(classes);
    ...
    createControllers(classes) {
        const controllers = !classes
            ? (0, index_1.getMetadataArgsStorage)().controllers
            : (0, index_1.getMetadataArgsStorage)().filterControllerMetadatasForClasses(classes);
    ...
    createActions(controller) {
        ...
        while (target) {
            const actions = (0, index_1.getMetadataArgsStorage)()
